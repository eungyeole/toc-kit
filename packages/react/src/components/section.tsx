...
import { TocSectionContextValue, TocSectionData } from '../types';
...
export const TocSection = forwardRef<HTMLElement, TocSectionProps>((props, ref) => {
  ...
  }, [id, title, level, parentContext.id, metadata, registerSection, unregisterSection]);
